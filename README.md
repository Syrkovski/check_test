...
4. Заполните форму «Создать БСО»: укажите количество занятий и цену за 1 занятие; поля «Клиент», «Название услуги», «Основание платежа», «Способ оплаты» уже заполнены фиксированными значениями и при желании разблокируются кнопками «Изменить разово» справа. Дата и время подставляются автоматически на момент генерации, но их можно задать вручную внизу формы.
