...
Минимальное веб‑приложение для генерации квитанций ИП без кассы. Работает целиком в браузере: сохраняет данные в `localStorage`, автоматически нумерует документы по формуле `YYYYMMDD-XXX`, генерирует PDF по фиксированному шаблону и ведёт реестр выданных квитанций.
...
4. Заполните форму «Создать квитанцию»: укажите количество занятий и цену за 1 занятие; поля «Клиент», «Название услуги», «Основание платежа», «Способ оплаты» уже заполнены фиксированными значениями и при желании разблокируются кнопками «Изменить разово» справа. Дата и время подставляются автоматически на момент генерации, но их можно задать вручную внизу формы.
